...
// cursed
type TSEslintRules = Record<string, Linter.RuleEntry<any>>;
...
const TSLintRules: TSEslintRules = {
...
export default TSEslint.config({ ignores: ["dist"] }, {
    files: [`src/**/*.${extensions}`, `eslint.config.${extensions}`, `electron.vite.config.${extensions}`, `electron/**/*.${extensions}`],
    plugins: {
        "@stylistic": stylistic,
